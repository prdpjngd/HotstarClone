          ...
          <div className="collapse navbar-collapse navbar-custom" id="navbarSupportedContent">
            <ul className="navbar-nav mr-auto">
              <li className="nav-item active">
                <Link className="nav-link" to="/filter/type/tv-show">
                  TV
                </Link>
              </li>
              <li className="nav-item">
                <Link className="nav-link" to="/filter/type/movie">
                  Movies
                </Link>
              </li>
              <li className="nav-item">
                <Link className="nav-link" to="/filter/type/sports">
                  Sports
                </Link>
              </li>
              <li className="nav-item">
            ...
            <ul className="navbar-nav ml-auto">
              ...
              this.props.user.isAnonymous === false ? (this.props.user.admin===true?<AdminUser />:
                <AuthUser />
              ) : (
                <AnonymousUser />
              )}
